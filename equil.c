	       ...
	       */
{
 ...
 FILE *f_eos;              /* pointer to eos_file */
    ...
    /* xp[begin_transition]=xp[begin_transition+1]=...=xp[end_transition] */
    fscanf(f_eos,"%d %d %d\n",n_tab,&begin_transition,&end_transition);
    /*
    fscanf(f_eos,"%d\n",n_tab);
    fscanf(f_eos,"%lf %lf %lf %lf %lf %lf %lf\n",
	    &pbrk,&ebrk0,&ebrk1,&hbrk0,&hbrk1,&nbrk0,&nbrk1);
    *pbrk = log10(*prk*KSCALE);
    *ebrk0 = log
    */
...
/*C*/
/*******************************************************************/
// Used in computing total mass in the end.
